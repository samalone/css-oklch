...
- `src/extension.ts` — Entry point. Registers the `DocumentColorProvider`, the color picker command, and the batch conversion commands (`cssOklch.convertSelection`, `cssOklch.convertDocument`).
